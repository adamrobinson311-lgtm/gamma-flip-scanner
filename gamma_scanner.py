...
def get_sp500_tickers() -> list[str]:
    """Return full S&P 500 ticker list (hardcoded for reliability in CI environments)."""
    log.info("Using hardcoded S&P 500 ticker list")
    return [
        ...
        "BK","BBWI","BAX","BDX","BRK-B","BBY","BIO","BIIB","BLK","BX","BA",
        "BMY","AVGO","BR","BRO","BLDR","BSX","CHRW","CDNS","CZR","CPT","CPB",
        ...
        "DECK","DE","DELL","DAL","DVN","DXCM","FANG","DLR","DFS","DG","DLTR",
        ...
        "GE","GEHC","GEN","GNRC","GD","GIS","GM","GPC","GILD","GS","HAL","HIG",
        "HAS","HCA","HSIC","HSY","HES","HPE","HLT","HOLX","HD","HON","HRL",
        "HST","HWM","HPQ","HUBB","HUM","HBAN","HII","IBM","IEX","IDXX","ITW",
        "INCY","IR","INTC","ICE","IFF","IP","IPG","INTU","ISRG","IVZ","INVH",
        "IQV","IRM","JNJ","JCI","JPM","JNPR","K","KVUE","KDP","KEY","KEYS",
        "KMB","KIM","KMI","KLAC","KHC","KR","LHX","LH","LRCX","LW","LVS",
        "LDOS","LEN","LIN","LYV","LKQ","LMT","L","LOW","LULU","LYB","MTB",
        ...
        "MSCI","NDAQ","NTAP","NFLX","NEM","NEE","NKE","NI","NDSN","NSC","NTRS",
        ...
        "PG","PGR","PLD","PRU","PEG","PTC","PSA","PHM","QCOM","DGX","RL","RJF",
        ...
        "URI","UNH","UHS","VLO","VTR","VRSN","VRSK","VZ","VRTX","VTRS","VICI",
        "V","VST","VMC","WRB","GWW","WAB","WBA","WMT","DIS","WBD","WM","WAT",
        "WEC","WFC","WELL","WST","WDC","WY","WMB","WTW","WYNN","XEL","XYL",
        "YUM","ZBRA","ZBH","ZTS",
    ]
